            ...
            <div class="bg-white dark:bg-title py-8 sm:py-10 md:py-[60px] px-5 sm:px-8">
                ...
                <div class="mt-10 md:mt-12">
                    ...
                    <div class="flex flex-wrap gap-[10px] md:gap-[15px] mt-5 md:mt-6">
                        <a class="btn btn-theme-outline btn-xs" href="#" data-text="Electronics"><span>Electronics</span></a>
                        <a class="btn btn-theme-outline btn-xs" href="#" data-text="Fashion"><span>Fashion</span></a>
                        <a class="btn btn-theme-outline btn-xs" href="#" data-text="Home & Living"><span>Home & Living</span></a>
                        <a class="btn btn-theme-outline btn-xs" href="#" data-text="Sports"><span>Sports</span></a>
                        <a class="btn btn-theme-outline btn-xs" href="#" data-text="Beauty"><span>Beauty</span></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-[940px] mx-auto">
            <div data-aos="fade-up">
                <ul class="flex items-center gap-[10px] flex-wrap">
                    ...
                    <li><a href="{{ url('/blog-v1') }}" class="inline-block text-title font-medium text-[15px] leading-none py-[10px] px-5 rounded-md bg-primary-midum">
                        @if(!empty($item['tag']))
                            {{ $item['tag'] }}
                        @else
                            Interior
            ...
            <div class="s-py-50" data-aos="fade-up" data-aos-delay="100">
                ...
                <img class="w-full" style="max-height: 383px; object-fit-cover background-position: center;" src="{{ !empty($item['img']) ? asset($item['img']) : asset('assets/img/thumb/blog-details.jpg') }}" alt="blog-details">
                ...
                <div class="md:max-w-[390px] w-full">
                        ...
                        <div class="flex-1">
                            <ul class="flex items-center gap-[10px] flex-wrap">
                                ...
                                <li><a href="{{ url('/blog-v1') }}" class="inline-block text-title font-medium text-[15px] leading-none py-[10px] px-5 rounded-md group-hover:bg-primary group-hover:text-white duration-300 bg-[#dbcbbd]">Shopping Tips</a></li>
                            </ul>
                            <h5 class="mt-3 font-medium dark:text-white leading-[1.5] text-xl"><a href="{{ url('/blog-details-v1') }}" class="text-underline">Smart Shopping Tips to Save More on Every Order</a></h5>
                        </div>
                        </div>
                </div>
                <div class="md:max-w-[390px] w-full">
                    ...
                    <div class="group flex sm:items-center gap-[15px]">
                        ...
                        <div class="flex-1">
                            <ul class="flex items-center gap-[10px] flex-wrap">
                                <li class="text-[15px] leading-none dark:text-white">6 Sep, 2025</li>
                                <li><a href="/{{ url('/blog-v2') }}" class="inline-block text-title font-medium text-[15px] leading-none py-[10px] px-5 rounded-md group-hover:bg-primary group-hover:text-white duration-300 bg-[#dbcbbd]">Home & Living</a></li>
                            </ul>
                            <h5 class="mt-3 font-medium dark:text-white leading-[1.5] text-xl"><a href="{{ url('/blog-details-v2') }}" class="text-underline">Top Trends in Home Living: What's Hot This Season</a></h5>
                        </div>
                    </div>
                </div>
            </div>
