...
$teams = [
    [
        ...
        'desc' => "Sarah leads our product design and user experience teams, ensuring that every customer interaction — from browsing to checkout — feels intuitive, fast, and enjoyable.",
    ...
    [
        ...
        'name' => 'James Carter',
        'title' => "CEO & Founder",
        'desc' => "As the founder of PeytonGhalib, James built the company on a vision of making quality products accessible to everyone. His leadership drives the company's mission for innovation, growth, and customer-first values.",
    ...
    [
        ...
        'desc' => "Daniel ensures smooth daily operations and efficient supply chain management. His expertise in logistics keeps our fulfilment process fast, accurate, and scalable as we grow.",
    ...
    [
        ...
        'name' => 'Priya Sharma',
        'title' => "Category & Merchandise Manager",
        'desc' => "Priya oversees product selection and category strategy across our entire catalogue. She partners with trusted brands and suppliers to ensure PeytonGhalib always offers the right products at the best prices.",
    ...
    [
        ...
        'desc' => "Nathan leads our technology team, keeping the platform fast, secure, and reliable. He is responsible for building and maintaining the seamless shopping experience that our customers rely on every day.",
        'class' => "group sm:grid sm:grid-cols-2 bg-[#F8F5F0] dark:bg-[#1E2A35]",
        'data' => "",
        'span' => "false",
        'span1' => "true",
    ...
    [
        ...
        'desc' => "Maria drives brand awareness and customer acquisition through data-led marketing campaigns. Her creative strategies have helped PeytonGhalib reach hundreds of thousands of shoppers nationwide.",
        'class' => "group flex flex-col-reverse sm:grid sm:grid-cols-2 bg-[#F8F5F0] dark:bg-[#1E2A35]",
        'data' => "200",
        'span' => "true",
        'span1' => "false",
