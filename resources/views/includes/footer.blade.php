    ...
    <div class="s-pt-100">
        <div class="container-fluid">
            ...
            <div class="max-w-[1722px] mx-auto flex items-start justify-between gap-10 s-pb-100 flex-wrap lg:flex-nowrap footer-wrapper">
                ...
                <div class="lg:max-w-[366px] sm:w-[45%] lg:w-full flex items-start justify-between gap-10 footer-inner-wrapper">
                    ...
                    <ul class="text-white leading-none flex flex-col gap-4">
                        <li class="duration-100 hover:text-primary inline-block group"><a class="text-underline-primary" href="{{ url('/about') }}">About Us</a></li>
                        <li class="duration-100 hover:text-primary inline-block group"><a class="text-underline-primary" href="{{ url('/faq') }}">FAQs</a></li>
                        <li class="duration-100 hover:text-primary inline-block group"><a class="text-underline-primary" href="{{ url('/terms-and-conditions') }}">Terms & Conditions</a></li>
                        <li class="duration-100 hover:text-primary inline-block group"><a class="text-underline-primary" href="{{ url('/contact') }}">Contact Us</a></li>
                    </ul>
                </div>
                    <div>
                    <h4 class="font-bold text-white leading-none mb-5 md:mb-6 text-xl md:text-2xl">Others</h4>
                    <ul class="text-white leading-none flex flex-col gap-4">
                        <li class="duration-100 hover:text-primary inline-block group"><a class="text-underline-primary" href="{{ url('/categories') }}">All Categories</a></li>
                        <li class="duration-100 hover:text-primary inline-block group"><a class="text-underline-primary" href="{{ url('/my-account') }}">My Account</a></li>
                        <li class="duration-100 hover:text-primary inline-block group"><a class="text-underline-primary" href="{{ url('/order-history') }}">Order History</a></li>
                    </ul>
                </div>
                </div>
                ...
                <div class="lg:max-w-[522px] w-full sm:text-center -order-1 lg:order-none">
                    ...
                    <p class="mt-4 text-white-light max-w-[522px] sm:mx-auto">PeytonGhalib is your one-stop online destination for thousands of products across electronics, fashion, home & living, sports, beauty, and more — all at unbeatable prices with fast, reliable delivery.</p>
                    <div class="flex items-center sm:justify-center gap-4 mt-6">
                        <a href="https://www.facebook.com/peytonghalib" target="_blank" rel="noopener noreferrer nofollow" class="w-10 h-10 rounded-full border border-white border-opacity-50 flex items-center justify-center group hover:border-primary duration-300" aria-label="Facebook">
                        ...
                        <a href="https://twitter.com/peytonghalib" target="_blank" rel="noopener noreferrer nofollow" class="w-10 h-10 rounded-full border border-white border-opacity-50 flex items-center justify-center group hover:border-primary duration-300" aria-label="Twitter">
                        ...
                        <a href="https://www.instagram.com/peytonghalib" target="_blank" rel="noopener noreferrer nofollow" class="w-10 h-10 rounded-full border border-white border-opacity-50 flex items-center justify-center group hover:border-primary duration-300" aria-label="Instagram">
                        ...
                        <a href="https://www.linkedin.com/company/peytonghalib" target="_blank" rel="noopener noreferrer nofollow" class="w-10 h-10 rounded-full border border-white border-opacity-50 flex items-center justify-center group hover:border-primary duration-300" aria-label="Linkedin">
                ...
                <div class="lg:max-w-[460px] sm:w-[45%] lg:w-full flex items-start justify-between gap-10 footer-inner-wrapper">
                    ...
                    <ul class="text-white leading-none flex flex-col gap-4">
                        <li class="duration-100 hover:text-primary inline-block group"><a class="text-underline-primary" href="{{ url('/shop') }}">All Products</a></li>
            ...
            <div class="max-w-[1722px] mx-auto border-t border-white border-opacity-10 py-5 md:py-7 text-center">
                <p class="text-white">© 2026 PeytonGhalib. Develop with <i class="mdi mdi-heart text-red-700"></i> by <a href="https://peytonghalib.com" target="_blank" rel="noopener noreferrer" class="text-reset">PeytonGhalib</a>.</p>
            </div>
        </div>
    </div>
</div>
