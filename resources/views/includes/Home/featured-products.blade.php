        ...
        <div class="group">
            <div class="relative overflow-hidden">
                <a href="{{ route('product-details', ['title' => Str::slug($item['title'])]) }}">
                    <img class="w-full transform group-hover:scale-110 duration-300 sm:max-h-[320px] object-cover" src="{{ asset($item['img']) }}" alt="product-card"> 
                </a>
    ...
    @foreach ($products1 as $item)
        <div class="group flex flex-col">
            <div class="relative overflow-hidden flex-1">
                <a href="{{ route('product-details', ['title' => Str::slug($item['title'])]) }}">
                    <img class="w-full transform group-hover:scale-110 duration-300 h-full object-cover" src="{{ asset($item['img']) }}" alt="product-card">
                </a>
