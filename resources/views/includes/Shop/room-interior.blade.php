    ...
    <div class="group">
        <div class="relative overflow-hidden">
            ...
            @if ($product->tag)
                ...
                @endphp
                <div class="absolute z-10 top-7 left-7 py-[11px] px-3 {{ $tagClass }} rounded-[30px] font-primary text-base text-white font-semibold leading-none">
                    {{ $tagLabel }}
                </div>
            @endif
        ...
        <div class="md:px-2 lg:px-4 xl:px-6 lg:pt-6 pt-5 flex gap-4 flex-col">
            <h4 class="font-medium leading-none dark:text-white text-lg">
                ...
                @if ($product->was_price)
                    <span class="text-title/50 line-through pl-2 inline-block">{{ $product->was_price }}</span>
                @endif
            </h4>
            <div>
...
@empty
    <div class="col-span-4 py-12 text-center text-gray-400">No products found.</div>
@endforelse
